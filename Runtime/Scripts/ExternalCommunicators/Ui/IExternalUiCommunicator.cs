...
namespace ElympicsPlayPad.ExternalCommunicators.Ui
{
    public interface IExternalUiCommunicator
    {
        ...
        /// <see cref="ElympicsPlayPad.ExternalCommunicators.Tournament.IExternalTournamentCommunicator.TournamentUpdated"/> event will be raised.
        /// </summary>
        /// <remarks>
        /// If you want to set a tournament not contained in the list displayed by this method as the current tournament,
        /// you can use <see cref="ElympicsPlayPad.ExternalCommunicators.Tournament.IExternalTournamentCommunicator.SetActiveTournament"/>.
        /// </remarks>
